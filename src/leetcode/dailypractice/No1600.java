...
class ThroneInheritance {
    ...
    private void dfs(String kingName, ArrayList<String> list) {
        if (!hashMap.containsKey(kingName)) {
            return;
        }
        ArrayList<String> children = hashMap.get(kingName);
